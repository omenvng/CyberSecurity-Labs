...
def check():
    ...
    listbox_succes = Listbox(frame2, bg="#4A945B", font=app_font, fg="black", listvariable=vars1, selectmode=MULTIPLE,
    ...
    listbox_fail = Listbox(frame2, bg="#C75A63", font=app_font, fg="black", listvariable=vars2, selectmode=MULTIPLE,
                           width=50, height=27, highlightthickness=3)
    listbox_fail.place(relx=0.55, rely=0.03, relwidth=0.45, relheight=0.9)
    listbox_fail.config(highlightbackground="red")

    changeBtn = Button(frame2, text='Change', command=change_failures, bg="#519487", fg="white", font=app_font,
                       padx='10px', pady='3px')
    changeBtn.place(relx=0.745, rely=0.93)

    backupBtn = Button(frame2, text='Restore', command=restore, bg="#519487", fg="white", font=app_font, padx='10px',
                       pady='3px')
...
lstbox = Listbox(frame, bg="#000000", font=app_font, fg="white", listvariable=vars, selectmode=MULTIPLE, width=150,
                 selectbackground='#519487', height=34, highlightthickness=3)
...
save_btn = Button(frame, bg="#ff5432", fg="white", font=btn_font, text="Save", width=13, height=1,
                  command=save_config).place(relx=0.01, rely=0.01)
import_btn = Button(frame, bg="#ff5432", fg="white", font=btn_font, text="Import", width=13, height=1,
                    command=import_audit).place(relx=0.01, rely=0.065)
download_btn = Button(frame, bg="#ff5432", fg="white", font=btn_font, text="Download", width=13, height=1,
                      command=extract_file).place(relx=0.01, rely=0.12)
select_all_btn = Button(frame, bg="#ff5432", fg="white", font=btn_font, text="Select All", width=13, height=1,
                        command=select_all).place(relx=0.01, rely=0.175)
deselect_all_btn = Button(frame, bg="#ff5432", fg="white", font=btn_font, text="Deselect All", width=13, height=1,
                          command=deselect_all).place(relx=0.01, rely=0.229)
exit_btn = Button(frame, bg="#ff5432", fg="white", font=btn_font, text="Exit", width=13, height=1,
                  command=main.quit).place(relx=0.01, rely=0.284)
global e
e = Entry(frame, bg="#ff5432", font=btn_font, width=25, textvariable=querry).place(relx=0.2, rely=0.04)
find_btn = Button(frame, bg="#ff5432", fg="white", font=btn_font, text="Find", width=8, height=1, command=find).place(
    relx=0.41, rely=0.035)
check_btn = Button(frame, bg="#ff5432", fg="white", font=btn_font, text="Check", width=8, height=1,
                   command=check).place(relx=0.485, rely=0.035)
